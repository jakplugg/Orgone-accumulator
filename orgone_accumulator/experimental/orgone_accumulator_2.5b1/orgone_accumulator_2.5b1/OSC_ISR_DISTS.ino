void FASTRUN outUpdateISR_DISTS(void) {
  ...
  switch (oscMode) {
    ...
    case 0:
      ...
      //main oscillator
      o1.phase = o1.phase + (33554432 << o1.octave);
     // o1.phaseRemain = (o1.phase << 9) >> 17;
      o1.wave = (FMTable[o1.phase >> WTShiftFM]);
      o1.nextwave =  (FMTable[(o1.phase + (33554432 << o1.octave)) >> WTShiftFM]);
      o1.wave = Interp512(o1.wave,o1.nextwave,o1.phase);
      o1.index = (FMIndex * o1.wave);
      o2.phase = o2.phase +  ((33554432 << o1.octave) + o1.index + o3.index);
      o2.phaseRemain = (o2.phase << 9) >> 17;

      o3.phase = o3.phase + (33554432 << o1.octave);
      o3.phaseRemain = (o3.phase << 9) >> 17;
      o3.wave = (FMTable[o3.phase >> WTShiftFM]);
      o3.nextwave =  (FMTable[(o3.phase + (33554432 << o1.octave)) >> WTShiftFM]);
