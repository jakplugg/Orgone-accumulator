void loop() {
  ...
  //inputVOct = powf(2.0,inputScaler); //uncomment for slightly more accurate v/oct conversion (but it is much slower)
  ...
  //inputVOct = tPow2(inputScaler); //new table based power function even faster but up to a cent more innacurate.
