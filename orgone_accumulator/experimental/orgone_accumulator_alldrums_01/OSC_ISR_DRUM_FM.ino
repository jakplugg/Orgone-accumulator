void FASTRUN outUpdateISR_DRUM_FM(void) {
  //noInterrupts();
  ...
  //oscs
  o1[RrN].phase = o1[RrN].phase + o1[RrN].phase_increment + (o1[RrN].amp * drum[RrN].envTemp[0]) + (o2[RrN].amp * o10[RrN].wave);
  ...
  //oscs 2------------------------------------------
o3[RrN].phase = o3[RrN].phase + o2[RrN].phase_increment + o6[RrN].phase ;//dummy wave for modulation
  o3[RrN].phaseRemain = (o3[RrN].phase << 9) >> 17;
  o10[RrN].wave = ((int32_t)(((GWThi1[o3[RrN].phase >> 23] * (511 - GremHi)) >> 9) + ((GWThi2[o3[RrN].phase >> 23] * (GremHi)) >> 9))) ;
  o10[RrN].nextwave =  ((int32_t)(((GWThi1[(o3[RrN].phase+nextstep) >> 23] * (511 - GremHi)) >> 9) + ((GWThi2[(o3[RrN].phase+nextstep) >> 23] * (GremHi)) >> 9)));
  o10[RrN].wave = o10[RrN].wave + ((((o10[RrN].nextwave - o10[RrN].wave)) * o3[RrN].phaseRemain) >> 15);
